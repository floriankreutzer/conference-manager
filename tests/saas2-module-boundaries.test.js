...
test('module graph resolves static and dynamic relative dependencies', () => {
  assert.deepEqual(moduleSpecifiers("import './a.js'; export { x } from './b.js'; import('./c.js');"), [
    './a.js',
    './b.js',
    './c.js',
  ]);
  ...
  assert.deepEqual(graph.get('src/index.js'), ['src/a.js']);
...
test('valid Tenant Admin section composition uses public contracts and injected adapters', () => {
  const violations = frontendSaas2BoundaryViolations({
    'src/tenant-admin/settings-shell.js': "import { createLocationsSection } from './sections/locations/index.js'; export { createLocationsSection };",
    'src/tenant-admin/sections/locations/index.js': "export { createLocationsSection } from './application.js';",
    'src/tenant-admin/sections/locations/application.js': "import { t } from '../../../core/i18n.js'; export const createLocationsSection = (adapter) => ({ adapter, title: t('nav.tenantAdmin') });",
    'src/core/i18n.js': 'export const t = (key) => key;',
  });
  assert.deepEqual(violations, []);
});

test('private cross-section imports and direct Platform access fail closed', () => {
  const violations = frontendSaas2BoundaryViolations({
    'src/tenant-admin/sections/catalog/index.js': "export * from './application.js';",
    'src/tenant-admin/sections/catalog/application.js': "import '../locations/private.js'; import '../../../platform/api-client.js';",
...
test('Production adapters cannot import Demo implementations', () => {
  const violations = frontendSaas2BoundaryViolations({
    'src/tenant-admin/production-adapter.js': "import './demo-adapter.js';",
    'src/tenant-admin/demo-adapter.js': 'export const demo = true;',
  });
